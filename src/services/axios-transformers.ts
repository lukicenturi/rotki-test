...
const createReviver = (numericKeys: string[] | null): ((key: string, value: any) => any) => (key: string, value: any) => {
...
export const axiosSnakeCaseTransformer: AxiosResponseTransformer = (data, _headers) => convertKeys(data, false, false);

export const axiosCamelCaseTransformer: AxiosResponseTransformer = (data, _headers) => convertKeys(data, true, false);
